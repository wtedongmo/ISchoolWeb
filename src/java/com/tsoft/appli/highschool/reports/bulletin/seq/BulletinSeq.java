...
@RestController
@RequestMapping("/app")
public class BulletinSeq extends EmptyReportProcess {
    ...
    public String libelle() {
        return "Bulletin Sequence Eleve";
    }
    ...
    public Object run(HttpSession session, HttpServletRequest request) throws Exception {
        ...
        reportfile = "classpath:com/tsoft/appli/highschool/reports/bulletin/seq/BulletinSeq.jasper";
        ...
        String destfile = uploadedfile.getAbsolutePath() + File.separator + "Bulletin"
                + ("SEQ") + getNumero_sequence() + getEleve().getNom_prenom() + ".pdf";
        //fill report

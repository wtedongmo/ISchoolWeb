...
@RestController
@RequestMapping("/app")
public class CarteScolaireAll extends EmptyReportProcess {
    ...
    public Object run(HttpSession session, HttpServletRequest request) throws Exception {
        ...
        reportfile = "classpath:com/tsoft/appli/highschool/service/CarteScolaireAll.jasper";

package com.tsoft.appli.highschool.timetable.graphColoring;

import com.tsoft.appli.highschool.timetable.model.Cours;
import java.util.*;

/**
 * The graph on which the algorithm runs. An object of this class is created and
 * populated by GraphReader.readGraph().
 *
 * @author Shalin Shah Email: shah.shalin@gmail.com
 */
public class Graph {
...
//    public Graph(List<Cours> courss) {
//        aMatrix = new int[Constants.NUMBER_NODES][Constants.NUMBER_NODES];
//        sortedNodes = new Node[Constants.NUMBER_NODES];
//        nodes = new Node[Constants.NUMBER_NODES];
//        for (int i = 0; i < Constants.NUMBER_NODES; i++) {
//            nodes[i] = new Node(courss.get(i).getCode());
//            sortedNodes[i] = nodes[i];
//        }
//    }
